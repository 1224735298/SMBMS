...
<!--头部-->
    <header class="publicHeader">
        ...
        <div class="publicHeaderR">
            <p><span>下午好！</span><span style="color: #fff21b"> ${userSession.userCode }</span> , 欢迎你！</p>
            <a href="${pageContext.request.contextPath }/user/userExit">退出</a>
        </div>
    </header>
<!--时间-->
     ...
     <div class="left">
         ...
         <nav>
             <ul class="list">
              ...
              <li><a href="${pageContext.request.contextPath }/user/userExit">退出系统</a></li>
             </ul>
         </nav>
     </div>
