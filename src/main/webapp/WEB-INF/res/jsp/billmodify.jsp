...
<div class="right">
        ...
        <div class="providerAdd">
          <form id="billForm" name="billForm" method="post" action="${pageContext.request.contextPath }/BillServlet">
                        ...
                        <c:if test="${providerList != null }">
                            ...
                            <c:forEach var="provider" items="${providerList}">
                                <c:if test="${provider.id == bill.providerId }">
                                    <option selected="selected" value="${provider.id}">${provider.proName}</option>
                                </c:if>
                                <c:if test="${provider.id != bill.providerId }">
