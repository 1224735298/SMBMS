...
<div class="right">
    ...
    <div class="search">
        <form method="post" action="${pageContext.request.contextPath }/ProviderServlet">
            ...
            <c:if test="${User.userRole==3}">
                <a href="${pageContext.request.contextPath }/ProviderServlet?method=query">刷新订单</a>
            </c:if>
    ...
    <table class="providerTable" cellpadding="0" cellspacing="0">
        ...
        <c:forEach var="provider" items="${pager.datas }" varStatus="status">
            <tr>
                <td>
                ...
                <td>
                 ...
                 <span><a class="modifyProvider"
                          href="${pageContext.request.contextPath }/ProviderServlet?method=toModify&id=${provider.id}"
                          proid=${provider.id } proname=${provider.proName }><img
